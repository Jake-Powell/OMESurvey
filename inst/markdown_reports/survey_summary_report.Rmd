...
for(sec in sections){
  ...
  if (length(vars) == 1 || (vars_in_sec |>
    ...
    labels_vec <- setNames(as.character(vars_in_sec$item_statement),
                           vars_in_sec$variable)
    ...
    tryCatch({
      # summary_plot_stacked_bar should draw or return a ggplot
      res <-
        OMESurvey::summary_plot_stacked_bar(
          df_plot,
          labels_vec,
          ...
          NA_label = "Missing/Non-allowed") |> #possibly add more here in due course
