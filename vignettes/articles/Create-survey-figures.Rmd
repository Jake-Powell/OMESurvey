...
In this case we can use `plot_theme()` to create a horizontal bar chart. Depending on the "Kind" argument we can create a formatted data frame, a ggplot or a plotly graph.
