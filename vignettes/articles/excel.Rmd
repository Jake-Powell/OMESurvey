---
title: "Creating branded Excel documents of survey results"
---
...
data$Year_7_maths_lessons__We_follow_a_book_or_worksheet_closely[data$Year_7_maths_lessons__We_follow_a_book_or_worksheet_closely == 'Neither'] = 'Half the time'
...
```{r, eval = F}
wb = OMESurvey::to_sheet_theme_summary(data = data, theme = 'Maths in Year 7')
